...
void Init(RenderContext* renderContext) {
    ...
    // Load the shaders.
    LoadShader("../Shaders/Mesh.vs", GL_VERTEX_SHADER, renderContext->m_shaderMesh.m_vertexShader);
    LoadShader("../Shaders/Mesh.fs", GL_FRAGMENT_SHADER, renderContext->m_shaderMesh.m_fragmentShader);
    LoadShader("../Shaders/FullscreenQuad.vs", GL_VERTEX_SHADER, renderContext->m_fullscreenQuadVertexShader);
    LoadShader("../Shaders/TextureSampling.fs", GL_FRAGMENT_SHADER, renderContext->m_shaderTextureSampling.m_fragmentShader);
