...
constexpr char VULKAN_MYSAMPLES_BASE_DIR[]="/home/MAGICLEAP/pmaciel/CodeExperiments/Vulkan/MySamples/";
...
std::string get_base_data_dir() {
    ...
    return "";
#else
    return std::string(VULKAN_MYSAMPLES_BASE_DIR) + "/source/data/";
#endif
}
#endif
